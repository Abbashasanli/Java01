...
create table GenreAssignment(
 ...
 values
         ('A Tale of Two Cities',' Charles Dickens','Chapman & Hall','1775-05-30',500 ),
...
VALUES
  ( 'John', 'Doe', 'Goven St', '5551234', 'john@gmail.com'),
  ('Jane', 'Smith', 'Elm St', '5555678', 'jane@gmail.com'),
   ('Alisa','Wonder','Man St','5551343','alisa@gmail.com');

insert into genre(Name) values ('war'),('detective'),('historical friction'),('fiction'),('satire');

insert into author (First_name, Last_name, Birth_year, Death_year)
 VALUES ('Charles','Dickens',1821,1870),('Arthur','Conan',1859,1930),
       ('Leo','Tolstoy',1829,1910),('George','Orwell',1903,1950);

insert into loan(book_id, reader_id, loan_date, return_date)
VALUES(2,1,'2023-05-07','2023-06-01'),(1,3,'2023-07-01',null),(5,2,'2023-07-10',null);

insert into authorship(book_id, author_id) VALUES (1,1),(2,2),(3,3),(4,1),(5,4);

insert into genreassignment (book_id, genre_id)
VALUES (1,3),(2,2),(3,1),(4,4),(5,4);
